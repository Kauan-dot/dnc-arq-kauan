                    ...
                    <div className="d-flex mobile-fd-column">
                        <div className="footer-col">
                            ...
                            <ul>
                                ...
                                <li><Link to="/projects">{appContext.languages[appContext.language].menu.about}</Link></li>
                                <li><Link to="/about">{appContext.languages[appContext.language].menu.projects}</Link></li>
